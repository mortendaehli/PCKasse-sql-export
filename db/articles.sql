...
FROM OrderLines orl
LEFT JOIN Articles art On art.ArticleID = orl.ArticleID
GROUP BY orl.ArticleID,  art.ArticleNo, art.Name
HAVING art.ArticleNo LIKE '1522%'
;
...
FROM Received rec
LEFT JOIN Sold sol ON sol.aid = rec.aid
GROUP BY rec.aid
HAVING rec.aid in (54159, 54160, 54162, 54163, 54164, 54165)